...
infer_output_dir ='/cluster/scratch/qimaqi/data_5k/val_unet++_6000_cpu_origin_max20000_9/' #'/cluster/scratch/qimaqi/data_5k/test_unet_6000_cpu_origin_max20000/'
...
val_image_list=[]
val_feature_list=[]
for i in (7,9,11,53,56,103,113,149,173,200,217,267,306,309,425,431,535,537,564,577,621,657,984): #range(len(val_5k_image_rgb)):  # problem have in 7: 636x960, 53:1200x855,  56: 896x584, 103:1200x900  113: 757x631  149: 888x1200
