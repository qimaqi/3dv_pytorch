...
scale = 1
dir_checkpoint = '/cluster/scratch/jiaqiu/checkpoints_6000_small/'
...
def get_args():
    ...
    parser.add_argument('-f', '--load', dest='load', type=str, default='/cluster/scratch/jiaqiu/checkpoints_6000/8.pth',
