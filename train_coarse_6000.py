...
dir_checkpoint = '/cluster/scratch/qimaqi/checkpoints_26_5_unet++_6000/'
...
def get_args():
    ...
    parser.add_argument('-f', '--load', dest='load', type=str, default='/cluster/scratch/qimaqi/checkpoints_25_5_unet++_6000/4.pth',
