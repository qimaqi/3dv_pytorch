...
def eval_net(net, loader, device):
    ...
    for batch in loader:
        ...
        # debug part
        tmp_output_dir = '/cluster/scratch/qimaqi/debug_output_eval_invnet_1_5_lr4/' +str(global_step) + '.png'
        tmp_img_dir = '/cluster/scratch/qimaqi/debug_images_eval_invnet_1_5_lr4/'+ str(global_step) + '.png'
