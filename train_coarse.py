...
dir_checkpoint = '/cluster/scratch/qimaqi/checkpoints_17_5_unet_max_1000_lr1e-4/'
...
def get_args():
    ...
    parser.add_argument('-f', '--load', dest='load', type=str, default='/cluster/scratch/qimaqi/checkpoints_16_5_unet_max_1000_lr1e-4/3.pth',
