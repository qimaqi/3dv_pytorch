...
dir_checkpoint = '/cluster/scratch/qimaqi/checkpoints_26_4_unet/'
...
def get_args():
    ...
    parser.add_argument("--per_loss_wt", type=float, default=10.0, help="%(type)s: Perceptual loss weight (default: %(default)s)")   
