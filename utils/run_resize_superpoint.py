...
if __name__ == '__main__':
    ...
    save_source_dir = '/cluster/scratch/qimaqi/data_5k/save_source_dir'
    ...
    weights_path = '/cluster/home/qimaqi/Workspace/src/3dv_pytorch/utils/weights/superpoint_v1.pth'
    nms_dist = 4
    conf_thresh = 0
    cuda = True
    ...
    for i in range(len(image_list)):
        ...
        input_image = read_image(test_image,resize_scale)

        pts, desc, heatmap = fe.run(input_image)


        new_pts=pts[:,0:6000]
        new_desc=desc[:,0:6000]
        np.savez_compressed(os.path.join(save_dir,save_name), pts=new_pts, desc=new_desc)
