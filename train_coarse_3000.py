...
dir_checkpoint = '/cluster/scratch/qimaqi/checkpoints_27_5_invnet_max_3000_lr1e-5/'
...
def get_args():
    ...
    parser.add_argument('-f', '--load', dest='load', type=str, default='/cluster/scratch/qimaqi/checkpoints_25_5_invnet_max_3000_lr1e-4/4.pth',
